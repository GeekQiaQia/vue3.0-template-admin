                ...
                <el-row>
                  <el-col :span="24" style="text-align: left">
                    ...
                    <p class="text-muted margin-bottom-1">
                      <span class="text-norap margin-right-1"><i class="el-icon-suitcase"></i> {{item.tag}}</span>
                      <span class="text-norap margin-right-1"><i class="el-icon-chat-line-square"></i> {{item.comments}} Comments</span>
                    </p>
                    <div class="flex flex-row flex-between">
              ...
              <el-card shadow="hover" class="card">
                <el-row>
                  <el-col :span="24" style="text-align: left">
                    ...
                    <p class="text-muted margin-bottom-1">
                      <span class="text-norap margin-right-1"><i class="el-icon-suitcase"></i> web</span>
                      <span class="text-norap margin-right-1"><i class="el-icon-chat-line-square"></i> 22 Comments</span>
                    </p>
                    <div class="flex flex-row flex-between">
                      <div class="flex flex-row flex-start align-center">
                ...
                <el-row>
                  <el-col :span="24" style="text-align: left">
                    ...
                    <p class="text-muted margin-bottom-1">
                      <span class="text-norap margin-right-1"><i class="el-icon-suitcase"></i> IOS</span>
                      <span class="text-norap margin-right-1"><i class="el-icon-chat-line-square"></i> 28 Comments</span>
                    </p>
                    <div class="flex flex-row flex-between">
                      <div class="flex flex-row flex-start align-center">
                        <el-avatar size="small" src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"></el-avatar>
