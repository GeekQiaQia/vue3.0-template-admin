        ...
        <el-col :offset="1" :span="22">
          <div class="grid-content bg-purple-dark">
            ...
            <el-card class="box-card">
              ...
              <div class="section">
                <div ref="itemsRef">
                  <fragment v-for="item in input" :key="item.id">
...
export default defineComponent({
  setup() {
    ...
    const cardInfo = reactive([
      ...
      {
        id: 6,
        imgSrc: 'http://h5.dooring.cn/uploads/logo_1742fd359da.png',
    ...
    onMounted(() => {
      const sortable = Sortable.create(itemsRef.value)
      console.log(sortable)
      // eslint-disable-next-line no-new
      const cardSortable = Sortable.create(cardRef.value, {
        group: 'grid',
        handle: '.handle', // handle's class
        animation: 150
      })
      console.log(cardSortable)
    })
